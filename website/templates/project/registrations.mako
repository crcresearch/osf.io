  ...
  <div role="tabpanel" class="tab-pane active" id="registrations">
    ...
    ##      %endif
        ...
        <p>
          ...
          % endif
          <p>For a list of the most viewed and most recent public registrations on the Craft Repository, click <a href="/explore/activity/#newPublicRegistrations">here</a>.</p>
        % endif
