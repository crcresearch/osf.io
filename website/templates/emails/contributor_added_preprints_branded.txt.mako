...
Want more information? Visit https://osf.io/preprints/${branded_service_name.lower()} to learn about ${branded_service_name} or https://osf.io/ to learn about the DARPA Craft Repository, or https://cos.io/ for information about its supporting organization, the Center for Open Science.
