...
<%def name="content()">
    <div style="margin: 40px;">
        ...
        Hello ${fullname},
        <br><br>
        Thanks for adding your presentation from ${conference} to the conference's <a href="${osf_url}">DARPA Craft Repository</a> (OSF) page! Sharing virtually is an easy way to increase the impact of your research.
        <br>
        %if downloads > 4:
